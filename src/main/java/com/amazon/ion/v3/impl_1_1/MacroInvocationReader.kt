...
//    var arguments: EExpressionArgsReader,
    ...
    var parentStream: ValueReader? = null
    ...
    fun init(
        ...
        startInclusive: Int,
        endExclusive: Int,
//        signature: List<Macro.Parameter>,
//        arguments: EExpressionArgsReader,
     ) {
...
//        this.arguments = arguments
    ...
    override fun close() {
        // TODO: Maybe the order of these should be switched.
        if (parentStream != null) {
            throw IllegalStateException("Cannot close this without taking the parent.")
        }
        pool.invocations.add(this)
    }

    fun takeParent(): ValueReader {
        val p = parentStream!!
        parentStream = null
        return p
    }
