...
class MacroInvocationReader(
    ...
    startInclusive: Int,
    endExclusive: Int,
): TemplateReaderBase(pool, info, startInclusive, endExclusive), SequenceReader {
...
//        // Macro Evaluation should not have unresolved symbols
//        return -1
//    }
//
...
//
//    // These should only apply to top-level readers.
