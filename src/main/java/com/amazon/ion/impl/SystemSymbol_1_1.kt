...
enum class SystemSymbol_1_1(val id: Int, val text: String) {
    ION(                    1, "\$ion"                    ),
    ION_1_0(                2, "\$ion_1_0"                ),
    ...
    companion object {
        private val ALL_VALUES: Array<SystemSymbol_1_1> = entries.toTypedArray().apply {
        ...
        operator fun contains(id: Int): Boolean {
            return id > 0 && id <= SystemSymbol_1_1.ALL_VALUES.size
        }
        ...
        operator fun get(id: Int): String? {
            return SystemSymbol_1_1.ALL_VALUES[id - 1].text
//            return if (id in this) SystemSymbol_1_1.ALL_VALUES[id - 1].text else null
        }
    }
}
