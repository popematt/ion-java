...
import com.amazon.ion.v8.IonRawTextWriter_1_1.ContainerType.*
...
class IonRawTextWriter_1_1 internal constructor(
    ...
    override fun stepInDirective(directive: Int) {
        val directiveName = when (directive) {
            Ops.SET_SYMBOLS -> ":\$set_symbols"
            Ops.ADD_SYMBOLS -> ":\$add_symbols"
            Ops.SET_MACROS -> ":\$set_macros"
            Ops.ADD_MACROS -> ":\$add_macros"
            Ops.USE -> ":\$use"
            Ops.MODULE -> ":\$module"
            Ops.ENCODING -> ":\$encoding"
            else -> throw IonException("Not a directive $directive")
        }
        stepInSExp(false)
