 ...
 */
internal class EncodingContext(
    private val ionReaderShim: IonReader
) {
...
//        defaultModule.symbols = newSymbols
    ...
    fun buildActiveMacroTable(additionalMacros: List<MacroV2> = emptyList()): Array<MacroV2> {
        return defaultModule.macros.map { (_, m) -> m }.let {
