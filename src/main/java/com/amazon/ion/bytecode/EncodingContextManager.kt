...
internal class EncodingContextManager {
     ...
     *
     */
    class Module(val symbols: Array<String>, val macros: Array<MacroImpl>, val macroNames: Array<String?>)
    ...
    fun getEffectiveSymbolTable(): Array<String?> = effectiveTables.symbols.unsafeGetArray() as Array<String?>
    fun getEffectiveConstantPool(): Array<Any?> = effectiveTables.constants.unsafeGetArray()

    fun getLstSnapshot() = ArrayBackedLstSnapshot(effectiveTables.symbols.toArray() as Array<String?>)
