...
internal class BytecodeIonReader(private var generator: BytecodeGenerator) : IonReader {
    ...
    override fun next(): IonType? {
        ...
        do {
            ...
            operation = Instructions.toOperation(instruction)
            operationKind = Operation.toOperationKind(operation)
    ...
    private fun handleSystemValue(instruction: Int) {
    ...
    private fun getType(instruction: Int): IonType? {
        return TOKEN_TO_ION_TYPES[Operation.toOperationKind(Instructions.toOperation(instruction))]
    }
    ...
    override fun timestampValue(): Timestamp? {
        ...
        return when (op) {
            ...
            // Nulls :/
            Operation.OP_NULL_NULL,
            Operation.OP_NULL_BOOL,
            Operation.OP_NULL_INT,
            Operation.OP_NULL_FLOAT,
            Operation.OP_NULL_DECIMAL,
            Operation.OP_NULL_TIMESTAMP,
            Operation.OP_NULL_STRING,
            Operation.OP_NULL_SYMBOL,
            Operation.OP_NULL_BLOB,
            Operation.OP_NULL_CLOB,
            Operation.OP_NULL_LIST,
            Operation.OP_NULL_SEXP,
            Operation.OP_NULL_STRUCT -> null
