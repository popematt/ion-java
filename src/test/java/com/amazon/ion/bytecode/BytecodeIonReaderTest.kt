...
//            generator.assertAllRefillsUsed()
    ...
    inner class `INT operations` {
        ...
        fun `read I_INT_CP`() {
            ...
            val generator = MockGenerator(
                Instructions.I_INT_CP.packInstructionData(4),
                I_END_OF_INPUT,
    ...
    inner class `DECIMAL operations` {
        ...
        fun `read I_DECIMAL_CP`() {
            val generator = MockGenerator(
                Instructions.I_DECIMAL_CP.packInstructionData(4),
                I_END_OF_INPUT,
                constants = ConstantPool().apply {
                    repeat(4) { add(null) }
                    add(Decimal.TEN)
    ...
    inner class `TIMESTAMP operations` {
        ...
        fun `read I_TIMESTAMP_CP`() {
            val generator = MockGenerator(
                Instructions.I_TIMESTAMP_CP.packInstructionData(4),
                I_END_OF_INPUT,
                constants = ConstantPool().apply {
                    repeat(4) { add(null) }
                    add(THE_TIMESTAMP)
    ...
    inner class `STRING operations` {
        ...
        fun `read I_STRING_CP`() {
            val generator = MockGenerator(
                Instructions.I_STRING_CP.packInstructionData(4),
                I_END_OF_INPUT,
                constants = ConstantPool().apply {
                    repeat(4) { add(null) }
                    add("hello world")
    ...
    inner class `SYMBOL operations` {
        ...
        fun `read I_SYMBOL_CP`() {
            val generator = MockGenerator(
                Instructions.I_SYMBOL_CP.packInstructionData(4),
                I_END_OF_INPUT,
                constants = ConstantPool().apply {
                    repeat(4) { add(null) }
                    add("hello world")
    ...
    inner class `LOB operations` {
        ...
        fun `read I_CLOB_CP`() {
            val generator = MockGenerator(
                Instructions.I_CLOB_CP.packInstructionData(4),
                I_END_OF_INPUT,
                constants = ConstantPool().apply {
                    repeat(4) { add(null) }
        ...
        fun `read I_BLOB_CP`() {
            val generator = MockGenerator(
                Instructions.I_BLOB_CP.packInstructionData(4),
                I_END_OF_INPUT,
                constants = ConstantPool().apply {
                    repeat(4) { add(null) }
                    add(ByteSlice(THE_BYTES, 0, 8))
